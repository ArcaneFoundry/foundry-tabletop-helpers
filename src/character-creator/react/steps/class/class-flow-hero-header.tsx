...
export function ClassFlowHeroHeader({
  ...
  return (
    <motion.header
      ...
      className={cn("mx-2 mt-2 px-4 pb-3 pt-3 md:px-6", className)}
      ...
      >
        ...
        <div className="relative z-10 flex flex-col gap-4 px-4 py-4 md:px-6 md:py-5 lg:flex-row lg:items-end lg:justify-between">
          <div className="min-w-0 max-w-3xl">
            ...
            <p className="cc-theme-copy mt-3 max-w-2xl font-fth-cc-body text-[0.96rem] leading-7">
              {description}
            </p>
          </div>

          <div className="flex flex-wrap items-center gap-2">
            <span className="cc-theme-badge cc-class-flow-hero-banner__badge inline-flex rounded-full px-3 py-1.5 font-fth-cc-ui text-[0.6rem] uppercase tracking-[0.2em]">
              {primaryBadgeLabel}
            </span>
            <span className="cc-theme-badge cc-theme-badge--muted cc-class-flow-hero-banner__badge cc-class-flow-hero-banner__badge--muted inline-flex rounded-full px-3 py-1.5 font-fth-cc-ui text-[0.6rem] uppercase tracking-[0.18em]">
              {secondaryBadgeLabel}
            </span>
          </div>
        </div>
